...
import ru.files.cloud.dto.FileDto;
import ru.files.cloud.entities.File;
import ru.files.cloud.entities.User;
import ru.files.cloud.exception.FileNotFoundException;
import ru.files.cloud.model.FileBody;
import ru.files.cloud.repository.FileRepository;
...
public class FileServiceTest {
    ...
    public void init() {
        ...
        fileFound = File.builder()
                ...
                .size(19L)
                .fileByte("Java 11 FileCloud".getBytes())
    ...
    void testUploadFile_thenSuccess() throws IOException {
        ...
        MultipartFile multipartFile =
                new MockMultipartFile("file", MY_FILE_NAME,
                        MediaType.TEXT_PLAIN_VALUE, "Java 11 FileCloud".getBytes());
