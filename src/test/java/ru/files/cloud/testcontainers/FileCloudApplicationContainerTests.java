package ru.files.cloud.testcontainers;
...
import ru.files.cloud.FileCloudApplication;
...
@Testcontainers
@SpringBootTest(classes = FileCloudApplication.class,
        webEnvironment = SpringBootTest.WebEnvironment.RANDOM_PORT)
public class FileCloudApplicationContainerTests {
    ...
    public static GenericContainer<?> appcloud =
            new GenericContainer<>("cloudapp:latest")
